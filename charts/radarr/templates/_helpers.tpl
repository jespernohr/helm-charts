...
{{/*
Create the config volume name
*/}}
{{- define "radarr.configVolumeName" -}}
{{- printf "%s-config" (include "radarr.fullname" .) }}
{{- end }}

{{/*
Create the media volume name
*/}}
{{- define "radarr.mediaVolumeName" -}}
{{- printf "%s-media" (include "radarr.fullname" .) }}
{{- end }}

{{/*
Create the downloads volume name
*/}}
{{- define "radarr.downloadsVolumeName" -}}
{{- printf "%s-downloads" (include "radarr.fullname" .) }}
{{- end }}